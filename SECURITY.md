# 🔒 Security Policy — Jirnyak/Bacevo
...
> Project Scope: `Bacevo Tensor Algebra & Isometric Collision Physics`
...
We actively maintain and provide critical security updates for the following release lines of **Jirnyak/Bacevo**:
...
Security engineering in Jirnyak/Bacevo is guided by the following domain-specific threat vector analyses:

### 1. Physics Tunneling
* **Description**: High-velocity particles passing through thin barriers without collision.
...
If you discover a security flaw or exploit vector in **Jirnyak/Bacevo**, do **NOT** post it publicly in open issues or discussions.
